...
namespace PlennerServerConsole
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IConsole_Bindings
        {
            ...
            // Console_obj1_Bindings

            public void SetDataRoot(global::PlennerServerConsole.Console newDataRoot)
            {
            ...
            private void Update_Server_Storage(global::PlennerServer.Server.ServerStorage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_Server_Storage_ServerData(global::PlennerServer.Server.ServerDataContainer obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
